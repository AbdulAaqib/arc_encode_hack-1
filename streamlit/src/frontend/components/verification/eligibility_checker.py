...
if __name__ == "__main__":
    ...
    async def main():
        print("Testing Eligibility Checker...\n")
        ...
        test_cases = [
            {
                "name": "High Score - No Bonuses",
                "trust_score": 85,
                "wallet_summary": {
                    "wallet_age_days": 30,
                    "tx_count": 10,
                    "total_value_moved": 1.0
                }
            },
            {
                "name": "Medium Score - With All Bonuses",
                "trust_score": 65,
                "wallet_summary": {
                    "wallet_age_days": 200,
                    "tx_count": 100,
                    "total_value_moved": 15.0
                }
            },
            {
            ...
            {
                "name": "Low Score - Eligible",
                "trust_score": 45,
                "wallet_summary": {
                    "wallet_age_days": 100,
                    "tx_count": 20,
                    "total_value_moved": 5.0
                }
            }
        ]
        ...
        for test in test_cases:
            print(f"=== {test['name']} ===")
            print(f"Trust Score: {test['trust_score']}")
            if test['wallet_summary']:
                print(f"Wallet Age: {test['wallet_summary']['wallet_age_days']} days")
                print(f"TX Count: {test['wallet_summary']['tx_count']}")
                print(f"Value Moved: {test['wallet_summary']['total_value_moved']} ETH")
