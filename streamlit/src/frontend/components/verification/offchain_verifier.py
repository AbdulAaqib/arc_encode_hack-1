...
if __name__ == "__main__":
    ...
    print("Testing OffChain Verifier...\n")
    
    # Test case 1: Good profile
    print("=== Test Case 1: Good Profile ===")
    result1 = verifier.compute_offchain_score(
        uploaded_files=[
    ...
    print("=== Test Case 2: Minimal Profile ===")
    result2 = verifier.compute_offchain_score(
        uploaded_files=None,
    ...
    print("=== Test Case 3: Invalid Inputs ===")
    result3 = verifier.compute_offchain_score(
        uploaded_files=[],
        email="invalid-email",
        phone="123",
        name="",
